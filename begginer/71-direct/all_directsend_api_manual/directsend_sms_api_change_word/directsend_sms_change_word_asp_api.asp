...
<%	
	...
	Dim title, message, sender, username, receiver, address_books, names, key, return_url
	...
	'* return_url_yn : 실제 발송결과를 return 받을 URL 사용 여부
	...
	receiver = "{""name"": ""강길동"", ""mobile"":"""", ""note1"":"""", ""note2"":"""", ""note3"":"""", ""note4"":"""", ""note5"":""""}"
	receiver = receiver & ",{""name"": ""홍길동"", ""mobile"":""수신자번호"", ""note1"":""다이렉트센드 2"", ""note2"":""다이렉트센드 3"", ""note3"":""다이렉트센드 4"", ""note4"":""다이렉트센드 5"", ""note5"":""다이렉트센드 6""}"
	...
	' 예약발송 정보 추가
	Dim sms_type, start_reserve_time, end_reserve_time, remained_count
    ...
    message = Replace(message, " ", " ")  '유니코드 공백문자 치환
	...
	'data = data & ", ""return_url_yn"":1 "			' return_url이 있는 경우 주석해제 바랍니다.(필수입력)
