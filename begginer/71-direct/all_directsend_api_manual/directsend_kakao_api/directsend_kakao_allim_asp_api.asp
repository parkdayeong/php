...
<%	
	...
	Dim username, key, url, kakao_plus_id, user_template_no, receiver, address_books
	Dim return_url_yn, return_url, kakao_faild_type, title, message, sender, reserve_type, start_reserve_time, end_reserve_time, remained_count
	...
	user_template_no = "directsend에 등록한 템플릿 번호"            '필수입력 (하단 251 라인 API 이용하여 확인)
	...
	data = data & ", ""user_template_no"":""" & user_template_no & """ "    '필수입력
	...
	'/* 발신프로필 / 템플릿 / 예약 API 사용시 여기까 삭제후 이용 하시기 바랍니다. */
	...
	'data = "{""username"":""" & username & """, ""key"":""" & key & """, ""template_type"":""3""}"			'JSON 데이터
